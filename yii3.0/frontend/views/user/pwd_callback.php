...
<center>
    ...
    <div class="loginbody">
        ...
        <div class="loginbox">
            ...
            <form action="index.php?r=user/pwd_callback" method="post" >
                <div class="login_table">
                    请输入您的用户名: <div class="login_name"><input name="username" class="login_input" placeholder="请输入您的用户名" type="text"></div>
                    请输入注册邮箱地址/手机号: <div class="login_pw"><input name="type" class="login_input" placeholder="请输入注册邮箱/手机号" ></div>
                    <div class="login_button"> <input name="submit" class="input_button" value="发送邮件找回密码" type="submit">
