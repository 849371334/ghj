...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <form id="reply-form" class="form-horizontal form ng-pristine ng-valid" action="?r=reply/video" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="panel panel-default tab-content">
                                        <div class="panel-heading">
                                            <ul class="nav nav-pills">
                                                <li class="active"><a href="http://wcmall.bj165.com/web/index.php?c=platform&amp;a=reply&amp;do=post&amp;m=video#contains" data-toggle="tab">包含关键字</a></li>
                                                <li><a href="http://wcmall.bj165.com/web/index.php?c=platform&amp;a=reply&amp;do=post&amp;m=video#regexp" data-toggle="tab">正则表达式模式匹配</a></li>
                                                <li><a href="http://wcmall.bj165.com/web/index.php?c=platform&amp;a=reply&amp;do=post&amp;m=video#trustee" data-toggle="tab">直接接管</a></li>
                                            </ul>
                                        </div>
...
<!--                                    </div>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <textarea style="height:80px;" class="form-control" cols="70" name="" placeholder="添加视频的简短描述"></textarea>
