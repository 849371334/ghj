								...
								<span style="cursor:pointer; color:#999;" class="setmeal-hover" data-uid="8" data-uniacid="asdfsdf" data-groupid="2">
									套餐 : <?php echo $group_name;?>								</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <a href="" target="_blank" class="manage"><i class="fa fa-cog"></i>管理公众号</a>
                                        </div>
                                    </div>
                                </div>
                                <ul class="panel-body list-group">
                                    <li class="row list-group-item" style="line-height:60px;">
                                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-1">
                                            <?php if(empty($data['head_url'])){?>
                                                <img src="ass/gw-wx.gif" class="" width="50" height="50" onerror="this.src=a/gw-wx.gif&#39;">
                                            <?php } else {?>
                                                <img src="<?php echo $data['head_url']?>" class="" width="50" height="50">
                                            <?php }?>
                                        </div>
                                ...
                                <div class="list-group-bottom">
                                    ...
                                    <div class="col-xs-6 text-right list-group-bottom-right">
                                        ...
                                        <?php if(isset($data['id'])){?>
                                            <a href="index.php?r=account/update&account_id=<?php echo $data['id']?>"><i class="fa fa-edit"></i>编辑</a>
                                            <a href="index.php?r=account/delete&account_id=<?php echo $data['id']?>" onclick="return confirm(&#39;删除主公众号其所属的子公众号及其它数据会全部删除，确认吗？&#39;);return false;"><i class="fa fa-times"></i>删除</a>
                                        <?php  } else {?>
