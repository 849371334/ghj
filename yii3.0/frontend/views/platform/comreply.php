...
<div class="col-xs-12 col-sm-9 col-lg-10">
	...
	<li class="active"><a href="./index.php?r=platform/comreply&apid=<?php echo $_GET['apid']; ?>"><i class="fa fa-edit"></i> 编辑自定义接口回复</a></li>
		</ul>
<style type="text/css">
...
<div class="clearfix ng-scope" id="js-reply-form" ng-controller="replyForm">
	<form id="reply-form" class="form-horizontal form ng-pristine ng-valid" action="./index.php?r=platform/comreply&apid=<?php  echo $_GET['apid']; ?>" method="post" enctype="multipart/form-data">
						...
						<li class="list-group-item">
							<div class="form-group">
								...
								<div class="col-sm-6 col-md-8 col-xs-12">
									<input type="text" class="form-control" placeholder="请输入回复规则的名称" name="reply_rule" value="<?php echo $info['reply_rule']; ?> ">
							...
							<div class="form-group ng-hide" ng-show="reply.advSetting">
								...
								<div class="col-sm-9">
									...
									if ($info['istop'] == 1) { ?>
	                                    <label class="radio-inline">
											<input type="radio" name="istop" ng-model="reply.entry.istop" ng-value="1" value="1" checked="checked" class="ng-pristine ng-untouched ng-valid"> 置顶
										</label>
										<label class="radio-inline">
											<input type="radio" name="istop" ng-model="reply.entry.istop" ng-value="0" value="0"  class="ng-pristine ng-untouched ng-valid"> 普通
										</label>
									<?php } else { ?>
	                                    <label class="radio-inline">
							...
							<div class="form-group ng-hide" ng-show="reply.advSetting &amp;&amp; !reply.entry.istop">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" placeholder="输入这条回复规则优先级" name="priority" value="<?php echo $info['priority']; ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-6 col-md-8 col-xs-12">
									<input type="hidden" name="wx_id" value="<?php  echo $_GET['apid']; ?>">
									...
									<input type="text" value='<?php echo $info['keywords']; ?>' class="form-control keyword ng-pristine ng-untouched ng-valid" placeholder="请输入触发关键字" ng-model="trigger.items.default" id="keywordinput" name="keywords" data-type="keyword">
			...
			<div>
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<?php 
						if ($info['apitype'] == 1) { ?>
                            <label for="radio_1" class="radio-inline"><input type="radio" name="apitype" id="radio_1" ng-model="item.type" value="1" checked='checked' class="ng-pristine ng-untouched ng-valid"> 远程地址</label>
						    <label for="radio_0" class="radio-inline"><input type="radio" name="apitype" id="radio_0" ng-model="item.type" value="2" class="ng-pristine ng-untouched ng-valid"> 本地文件</label>
						<?php } else { ?>
						    ...
						    <label for="radio_0" class="radio-inline"><input type="radio" name="apitype" id="radio_0" ng-model="item.type" value="2" checked='checked' class="ng-pristine ng-untouched ng-valid"> 本地文件</label>
						<?php } ?>
					</div>
				</div>
				<div class="form-group ng-hide" id='type1' ng-show="item.type == 1 ">
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" id="" value='<?php echo $info['apiurl']; ?>' class="form-control ng-pristine ng-untouched ng-valid" placeholder="" name="apiurl" ng-model="item.apiurl">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="wetoken" value='<?php echo $info['wetoken']; ?>' class="form-control" ng-model="item.token">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" value='<?php echo $info['default'] ?>' class="form-control" placeholder="" name="default" ng-model="item.default_text">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" id="" class="form-control" placeholder="" name="cachetime" ng-model="item.cachetime" value='<?php echo $info['cachetime'] ?>'>
