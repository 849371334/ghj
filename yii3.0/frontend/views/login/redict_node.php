	...
	<div class="navbar navbar-static-top" role="navigation" style="padding-top:20px;">
		<div class="container-fluid">
			<ul class="nav navbar-nav pull-right" style="padding-top:10px;">
				<a href="http://wcmall.bj165.com/web/index.php?c=account&amp;a=display&amp;" class="tile img-rounded">
			...
			<div class="jumbotron clearfix alert alert-success">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
						<h2></h2>
						<p>无权限</p>
																		<p><a href="index.php?r=login/login" class="alert-link">如果你的浏览器没有自动跳转，请点击此链接</a></p>
						<script type="text/javascript">
							setTimeout(function () {
